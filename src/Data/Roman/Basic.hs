...
instance Roman RomanSymbol where
  ...
  toRoman :: Integral a => a -> RomanSymbol
  toRoman      0 = N  
  toRoman      1 = I
  toRoman      5 = V 
  toRoman     10 = X
...
instance Roman RomanNumeral where
  ...
  toRoman :: Integral a => a -> RomanNumeral
    ...
    where
      ...
      part [] (x : xs) =
        case readsPrec 1 (x : xs) :: [(RomanSymbol, String)] of
          ...
          [(a, _)] -> part [a] xs
          _anyelse ->
            error "Data.Roman.Basic: ERROR 2 in Instance Read RomanNumeral"
      ...
      part acc xs =
        case (readsPrec 1 xs :: [(RomanSymbol, String)]) of
          ...
          _anyelse ->
            error "Data.Roman.Basic: ERROR 3 in Instance Read RomanNumeral"
